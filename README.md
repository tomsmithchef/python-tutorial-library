...
This folder contains a self-contained web textbook for the first seven Python fundamentals lessons. It was built from the original lesson PDFs and assignment text files, with the study material rewritten into longer beginner-friendly explanations.
...
- `Lesson 1.pdf` through `Lesson 7.pdf` - original lesson slide decks
- `Lesson 1 Assignments.txt` through `Lesson 4 Assignments.txt` - assignment/lab source text
- Lessons 5, 6, and 7 currently use embedded lesson activities from the PDFs only; assignment/lab text can be added later
